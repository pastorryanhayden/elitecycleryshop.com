...
var fileAbout = 'src/data/abouts.json';
var abouts = new Airtable({ apiKey: config.apikey }).base(config.abouts);
var aboutJson = [];
var aboutJsonTest = [];

var fileBikes = 'src/data/bikes.json';
var bikes = new Airtable({ apiKey: config.apikey }).base(config.bikes);
var bikesJson = [];
var bikesJsonTest = [];

var filePages = 'src/data/pagesData.json';
var pages = new Airtable({ apiKey: config.apikey }).base(config.web);
var pagesJson = [];
var pagesJsonTest = [];

var fileHeaders = 'src/data/headers.json';
var headers = new Airtable({ apiKey: config.apikey }).base(config.web);
var headersJson = [];
var headersJsonTest = [];

var fileQuotes = 'src/data/quotes.json';
var quotes = new Airtable({ apiKey: config.apikey }).base(config.web);
var quotesJson = [];
var quotesJsonTest = [];

var fileEvents = 'src/data/events.json';
var event = new Airtable({ apiKey: config.apikey }).base(config.web);
var eventsJson = [];
var eventsJsonTest = [];

var filePhotos = 'src/data/photos.json';
...
// headers 
    ...
    headers('header').select({
      ...
      // help https://support.airtable.com/hc/en-us/articles/203255215-Formula-Field-Reference
        ...
        records.forEach(function(record) {
          headersJson.push(record._rawJson.fields);
      ...
      jsonfile.writeFile(fileHeaders, headersJson, function (err) {
        console.error(err)
      });
      console.log('headers worked');
    });
...
var filenewRoadBikes = 'src/data/newRoadBikes.json';
...
var filenewTriBikes = 'src/data/newTriBikes.json';
...
var filenewMtnBikes = 'src/data/newMtnBikes.json';
...
var filenewLsBikes = 'src/data/newLsBikes.json';
...
var fileusedRoadBikes = 'src/data/usedRoadBikes.json';
...
var fileusedTriBikes = 'src/data/usedTriBikes.json';
...
var fileusedMntBikes = 'src/data/usedMntBikes.json';
...
var fileusedLsBikes = 'src/data/usedLsBikes.json';
...
var filenewKidsBikes = 'src/data/newKidsBikes.json';
...
var fileusedKidsBikes = 'src/data/usedKidsBikes.json';
...
// Accessories 
var fileAccessories = 'src/data/Accessories.json';
...
// Apparel 
var fileApparel = 'src/data/Apparel.json';
...
// Parts 
var fileParts = 'src/data/Parts.json';
...
// Misc 
var fileMisc = 'src/data/Misc.json';
...
// Packages 
var filePackages = 'src/data/Packages.json';
...
// AutoRack 
var fileAutoRack = 'src/data/AutoRack.json';
...
// FrameService 
var fileFrameService = 'src/data/FrameService.json';
...
// WheelService 
var fileWheelService = 'src/data/WheelService.json';
...
// BrakeService 
var fileBrakeService = 'src/data/BrakeService.json';
...
// ShiftService 
var fileShiftService = 'src/data/ShiftService.json';
...
// BottomBracket 
var fileBottomBracket = 'src/data/BottomBracket.json';
...
// AccessoryInst 
var fileAccessoryInst = 'src/data/AccessoryInst.json';
...
// ForkSusp 
var fileForkSusp = 'src/data/ForkSusp.json';
